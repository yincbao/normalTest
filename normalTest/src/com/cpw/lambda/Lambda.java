...
import com.cpw.lambda.dto.User;
...
public class Lambda {
	...
	public static void testOptions(){
		...
		Optional<com.cpw.lambda.dto.User> op = Optional.ofNullable(new User("admin"));
		Optional<com.cpw.lambda.dto.User> op1 = op.map(new Function<User,User>(){
			@Override
		...
		Optional<com.cpw.lambda.dto.User> op2 = op.map(
				(User user)->{
